...
<body>
  ...
  <nav class="red">
    <div class="nav-wrapper container ">
        <a href="#" class="center brand-logo " href="index.html"><img src="{{ asset('assets/img/logo.png') }}"></a>          
      <ul class="right ">                                 
  ...
  <ul id="slide-out" class="sidenav " >
    <li><div class="user-view">
        ...
        <img src="{{ asset('assets/img/office.jpg')}}" style="opacity: 0.5"> 
        </div>
        <a href="#user"><img class="circle" src="{{ asset('assets/img/user.jpg') }}"></a>
