...
<html lang="en">
    <head>
        ...
        <link href="<?php echo e(asset('herculano/css/styles.css')); ?>" rel="stylesheet" />
    </head>
    <body>
        <!-- Navigation-->
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="categoriasDropdown">
                              <?php $__currentLoopData = $categoriasMenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoriaM): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                  <a class="dropdown-item" href="<?php echo e(route('site.categoria', $categoriaM->id)); ?>">
                                    <?php echo e($categoriaM->nome); ?>
                    ...
                    <div class="d-flex">
                        <ul class="btn btn-outline-dark">
                            <li style="list-style: none;">
                                <a class="bi-cart-fill me-1" style="text-decoration: none; color: #020202;" href="<?php echo e(route('site.carrinho')); ?>"
                                onmouseover="this.style.color='white'"
                                onmouseout="this.style.color='#020202';"
                                >Carrinho
                                    <span class="badge bg-dark text-white ms-1 rounded-pill"><?php echo e(\Cart::getContent()->count()); ?></span>
                                </a>
                            </li>
                        </ul>
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <div class="dropdown mx-2">
                                ...
                                <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="<?php echo e(route('login.logout')); ?>">Sair</a></li>                                
                                </ul>
                            </div>
                        <?php else: ?>
                        <div class="mx-2">

                            <a class="btn btn-dark" href="<?php echo e(route('login.form')); ?>" role="button">Entrar</a>
                        </div>
                        <?php endif; ?>
...
<?php /**PATH C:\laragon\www\ecommerce\resources\views/site/layout.blade.php ENDPATH**/ ?>