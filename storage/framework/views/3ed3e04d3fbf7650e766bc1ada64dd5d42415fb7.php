...
<body>
  ...
  <nav class="red">
    <div class="nav-wrapper container ">
        <a href="#" class="center brand-logo " href="index.html"><img src="<?php echo e(asset('assets/img/logo.png')); ?>"></a>          
      <ul class="right ">                                 
          <li class="hide-on-med-and-down"><a href="#" onclick="fullScreen()"><i class="material-icons">settings_overscan</i> </a> </li>
          <li><a href="#" class="dropdown-trigger" data-target='dropdown2'>Olá <?php echo e(auth()->user()->firstName); ?><i class="material-icons right">expand_more</i> </a></li>     
      </ul>
  ...
  <ul id="slide-out" class="sidenav " >
    <li><div class="user-view">
        ...
        <img src="<?php echo e(asset('assets/img/office.jpg')); ?>" style="opacity: 0.5"> 
        </div>
        <a href="#user"><img class="circle" src="<?php echo e(asset('assets/img/user.jpg')); ?>"></a>
...
</html><?php /**PATH C:\laragon\www\ecommerce\resources\views/admin/layout.blade.php ENDPATH**/ ?>